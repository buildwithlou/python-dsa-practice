...
def my_decorator(func):
    def wrapper(*args, **kwargs): #this two arguments allow to pass any number of positional and keyword arguments to the original function. even just one or none.
        print("Before the function runs")
