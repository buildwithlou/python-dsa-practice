...
person = {"name": "Carlos", "age": 25, "city": "Miami"}
...
)  # GET method allows us to provide a default value if the key is not found
...
fruits = [
    ...
    "banana",
    "apple",
]  # this is a list of fruits with duplicates
...
for fruit in fruits:  # we go through each fruit in the list
    if fruit in count:  # if we have already seen this fruit, we increment the count
        ...
        count[fruit] = (
            1  # if we haven't seen this fruit before, we add it to the dictionary with a count of 1
        )
